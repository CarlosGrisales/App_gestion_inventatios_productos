...
const InventorySchema = CollectionSchema(
  ...
  links: {
    r'products': LinkSchema(
      id: -1246064422352756643,
      name: r'products',
      target: r'Product',
      single: false,
      linkName: r'inventory',
    )
  },
  embeddedSchemas: {},
...
extension InventoryQueryLinks
    on QueryBuilder<Inventory, Inventory, QFilterCondition> {
  QueryBuilder<Inventory, Inventory, QAfterFilterCondition> products(
  ...
  QueryBuilder<Inventory, Inventory, QAfterFilterCondition> productsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
